        ...
        <!-- Topbar Start -->
                    <div class="navbar-custom">
                        <ul class="list-unstyled topbar-menu float-end mb-0">
                            ...
                            <li class="dropdown notification-list d-none d-sm-inline-block" hidden>
                                <a hidden class="nav-link dropdown-toggle arrow-none" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                            ...
                            <li class="dropdown notification-list">
                                <a class="nav-link dropdown-toggle nav-user arrow-none me-0" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false"
                                    ...
                                    <span class="account-user-avatar"> 
                                        ...
                                        ?>
                                        <img src="<?php echo $profileImg; ?>" alt="user-image" class="rounded-circle">
                                    </span>
                                    <span>
                                        ...
                                        <span class="account-position">
                                            <?php
                                                if (isset($_SESSION['user']['type']) && $_SESSION['user']['type'] == 0) {
                                                    ...
                                                    echo htmlspecialchars($_SESSION['user']['name'] ?? 'Admin');
                                                }
                                            ?>
                                        </span>
                                    </span>          </a>
